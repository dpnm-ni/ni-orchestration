...
class ScalingApi(object):
    ...
    def create_scaling(self, scaling_info, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.create_scaling_with_http_info(scaling_info, **kwargs)  # noqa: E501
        else:
            (data) = self.create_scaling_with_http_info(scaling_info, **kwargs)  # noqa: E501
            return data

    def create_scaling_with_http_info(self, scaling_info,**kwargs):  # noqa: E501
    ...
    def get_all_scaling(self, **kwargs):  # noqa: E501

        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_scaling_with_http_info( **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_scaling_with_http_info( **kwargs)  # noqa: E501
            return data

    def get_all_scaling_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[AutoScaler]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
